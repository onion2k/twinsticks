...
var Sticks = function () {
    ...
    _createClass(Sticks, [{
        ...
        key: 'sticks',
        value: function sticks() {
            var _this = this;

            this.state.touches.forEach(function (t) {

                _this.controllerCtx.strokeStyle = '#00f';
                if (t.x > _this.dimensions.width * 0.5) {
                    _this.controllerCtx.strokeStyle = '#0f0';
                }

                _this.controllerCtx.beginPath();
                _this.controllerCtx.arc(t.x, t.y, 150, 0, 2 * Math.PI);
                _this.controllerCtx.stroke();
            });
        }
    }, {
        key: 'attach',
        value: function attach() {
            ...
            this.controllerEl.addEventListener('touchstart', function (e) {
                e.preventDefault();
                _this2.state.touches.push({
...
var c = new _sticks2.default('#controller');
},{"./sticks":11}],8:[function(require,module,exports) {
...
//# sourceMappingURL=/src.bd051c85.map